...
this.play=function(){if(this.timer===0)this.scheduleNextFrame();}
...
this.goTo=function(index){var count=this.items.length;var diff=index-(this.floatIndex()%count);if(2*Math.abs(diff)>count)diff-=(diff>0)?count:-count;this.destRotation=this.rotation;this.go(-diff);return diff;}
